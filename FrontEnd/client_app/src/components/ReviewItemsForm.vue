...
<style scoped>
/* 複製並統一 CustomerInfo.vue 的樣式 */
.formContainer { margin-bottom: 1rem; background-color: #fff; border: 1px solid #ddd; border-radius: 8px; overflow: hidden; }
.formSectionTitle { padding: 1rem; background-color: #00a19b; font-size: 1.1rem; font-weight: 600; border-bottom: 1px solid #ddd; display: flex; justify-content: space-between; align-items: center; }
...
.collapse-enter-to, .collapse-leave-from { max-height: 3000px; opacity: 1; } /* 維持較大的 max-height 以容納內容 */

/* 新增 form-content 容器以統一 padding */
...
/* 表格樣式 */
.review-grid-table { border: 1px solid #ddd; }
